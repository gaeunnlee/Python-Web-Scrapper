...
def add_to_dict(dictionary="x", word="x",meaning="x"):
  if type(dictionary) is dict:
    if word == "x" or meaning == "x":
...
def get_from_dict(dictionary="x", word="x"):
  if type(dictionary) is dict:
    if word == "x":
...
def update_word(dictionary="x", word="x",meaning="x"):
  if type(dictionary) is dict:
    if word == "x" or meaning == "x":
      print("You need to send a word and a definition.")
    elif word not in dictionary:
...
def delete_from_dict(dictionary="x", word="x"):
  if type(dictionary) is dict:
    if word == "x":
